...
public class DashBoardController  extends MainDashBoard implements Initializable {
    ...
    private void setVisitorBarValues() throws SQLException, ClassNotFoundException {
    ...
    private void setBarValues() throws SQLException, ClassNotFoundException {
    ...
    private void setTotalCount() throws SQLException, ClassNotFoundException {
        totalInmateCount.setText(String.valueOf(inmateBO.getAllInmate().size())+" Inmates");
        totalOfficerCount.setText(String.valueOf(officerBO.getAllOfficer().size())+" Officers");
