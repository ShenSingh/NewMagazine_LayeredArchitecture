...
public class FinancialPageController extends MainDashBoard implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        setLyValues();
        Map<String, Double> totalCost = null;
        try {
            totalCost = expencesBO.getTotalCostByType();
    ...
    private void searchExpenId() throws SQLException, ClassNotFoundException {
        List<String> expenIds = new ArrayList<>();

        List<ExpencesDTO> allExpens = expencesBO.getAllExpences();
        for (ExpencesDTO expences : allExpens) {
            expenIds.add(expences.getExpencesID()+" - "+expences.getType());
        }
    ...
    private void setValuesLineChart() {
        try {
            Map<String, XYChart.Series<String, Number>> expensesData = expencesBO.getExpensesDataForLineChart();
